...
void NovoAluno()
{
    ...
    if(strcmp(senhamestre,"teste") == 0)
    {
        ...
        do
        {
            numerodamatricula=(20191000+(rand()%999));
        ...
        while(   (data>99999999) || (data<10000000)     );
        ...
        if(turminha == 1)
        {
            ...
            fprintf(alun,"%d%s %s %s %d %s %s %d %d %d %d %d %d %d\n",numerodamatricula,tur,senha,nome,data,email,tele,presen,falta,nota1,nota2,nota3,nota4,turminha);
            fclose(alun);
            FILE *policia14;
